...
type Partner = { id: string; status: "PENDING" | "ACTIVE" | "SUSPENDED"; createdAt: string; user: { name: string | null; email: string }; assignments: { id: string }[] };
