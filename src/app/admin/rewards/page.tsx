...
export default function AdminRewardsPage() {
  ...
  async function submitPayment(event: FormEvent<HTMLFormElement>, reward: Reward) {
    ...
    if (!attachmentUrl || !attachmentName || !attachmentType) {
      setBusy("");
      setMessage("مرفق إثبات الدفع مطلوب قبل تسجيل المكافأة كمدفوعة.");
      return;
    }
