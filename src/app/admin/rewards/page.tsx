...
export default function AdminRewardsPage() {
  ...
  return <AdminShell active="rewards" title="مكافآت السفراء" description="مراحل مالية واضحة، نسب محفوظة، والاستحقاق يتحول تلقائيًا بعد الإنجاز والاعتماد والدفع.">
