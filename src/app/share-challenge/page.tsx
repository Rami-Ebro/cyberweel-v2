    ...
    <main dir="rtl" className="min-h-screen bg-[#F7F3EB] px-4 py-12 text-[#111827]">
      <div className="mx-auto max-w-2xl rounded-3xl border border-[#D8D2C4] bg-white p-7 shadow-xl">
        ...
        <form onSubmit={submit} className="mt-7 grid gap-4 sm:grid-cols-2">
          <input name="name" required placeholder="الاسم أو اسم الشركة" className="rounded-xl border border-[#D8D2C4] px-4 py-3 outline-none focus:border-[#B89A5A] sm:col-span-2" />
          <input name="email" type="email" required placeholder="البريد الإلكتروني" className="rounded-xl border border-[#D8D2C4] px-4 py-3 outline-none focus:border-[#B89A5A]" />
          <input name="phone" required placeholder="رقم الهاتف أو واتساب" className="rounded-xl border border-[#D8D2C4] px-4 py-3 outline-none focus:border-[#B89A5A]" />
