  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/70 bg-background/90 backdrop-blur-md">
      <div className="cw-container flex h-24 items-center justify-between">
        <a href={PUBLIC_VIEW_PATHS.home} onClick={(event) => handlePublicLink(event, "home")} className="focus-ring rounded-md" aria-label={`CyberWeel — ${t.nav.home}`}><span className="sm:hidden"><Logo size={42} /></span><span className="hidden sm:inline-flex"><Wordmark isArabic={isArabic} /></span></a>
