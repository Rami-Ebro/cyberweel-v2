      ...
      <div className="cw-container grid items-center gap-12 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:py-28">
        <div>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <a href="/wa" target="_blank" rel="noopener noreferrer" className="focus-ring inline-flex min-h-12 items-center justify-center rounded-md bg-camel px-6 text-base font-semibold text-ink transition hover:bg-camel/90">
              {copy.primary}
            </a>
