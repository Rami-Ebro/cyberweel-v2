    ...
    <div>
      ...
      <Section tone="floral" className="!pt-0">
        <SectionHeading
          ...
          intro={
            isArabic
              ? "نبدأ بفهم المشكلة والقرار الصحيح، ثم ننفّذ ما يحتاجه مشروعك فعلًا"
              : "We begin with the problem and the right decision, then build what your business truly needs"
          }
          className="mx-auto"
        />
        ...
        <div className="mx-auto mt-6 max-w-6xl rounded-xl border border-camel/30 bg-camel/5 px-6 py-5 text-center">
          <p className="font-display text-xl font-medium leading-relaxed text-ink sm:text-2xl">
            {isArabic
              ? "وأي شيء تقني يمكن أن يساهم في حل مشكلة التقدّم والنمو لديك"
              : "And anything technical that can help solve your progress and growth challenge"}
          </p>
        </div>
      </Section>
          ...
          {h.process.map((p, index) => (
            ...
            >
              ...
              <div className="mt-5 border-t border-border/70 pt-4">
                <span
                  className="block h-px w-10 bg-accent/50 transition-all duration-300 group-hover:w-16"
                  aria-hidden
                />
              </div>
            </motion.article>
