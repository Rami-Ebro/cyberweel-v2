    ...
    <AnimatePresence>
      {show && (
        <motion.a
          ...
          className={cn(
            "fixed bottom-[calc(1.5rem+env(safe-area-inset-bottom))] left-4 z-40 flex h-12 w-12 items-center justify-center rounded-full border border-camel/40 bg-ink text-camel shadow-lg transition-colors hover:bg-ink/90 sm:left-6",
            className,
          )}
          aria-label="WhatsApp"
        >
